        ...
        <ol>
          <li style={{ marginTop: '4%' }}>
            ...
            <p>
              ...
              information will get encrypted by your SSI Travel Rule Key
              generated by your permawallet - only you decide who can read this
              message. You won&apos;t need to give this information anymore to
              third parties, over and over again. Your SSI Travel Rule - private
              - Key will get encrypted by your SSI Permawallet Key and saved
              into your wallet, so only you can access it. When making a
              transfer, you will have the option to attach this secret encrypted
              by the beneficiary&apos;s SSI Communication Key so they can read
              your Travel Rule Passport.
            </p>
            <form>
          ...
          <li style={{ marginTop: '6%' }}>
            ...
            {register === 'registered' && (
              <p style={{ marginTop: '4%' }}>
                ...
                in the browser and make sure your SSI Permawallet Key is
                connected.
              </p>
            )}
          </li>
